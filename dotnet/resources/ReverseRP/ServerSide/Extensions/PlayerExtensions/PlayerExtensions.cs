...
public static class PlayerExtensions
{
    ...
    public static void SendNotify(this Player player,NotifyType notifyType, string message) => player.TriggerCefEvent("SERVER::CEF::NOTIFY",(int)notifyType,message);
    public static void FreezePlayer(this Player player,bool toggle) => player.TriggerEvent("SERVER::CLIENT::FREEZE_PLAYER",toggle);
    public static void SetCamera(this Player player, Vector3 positionCamera, Vector3 pointCamAtCoord, bool active) => player.TriggerEvent("SERVER|CEF::CLIENT::SET_GENERAL_CAMERA", positionCamera, pointCamAtCoord, active);
